...
if __name__ == '__main__':
    ...
    for dataset in datasets:
        ...
        # make folder for FlyingSquid specifically
        method_result_path = os.path.join(dataset_result_path, 'FlyingSquid')
        ...
        logger.info('============Running FlyingSquid============')
