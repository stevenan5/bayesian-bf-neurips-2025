...
from wrench.labelmodel import IBCC
...
if __name__ == '__main__':
    ...
    for dataset in datasets:
        ...
        # make folder for IBCC specifically
        method_result_path = os.path.join(dataset_result_path, 'IBCC')
