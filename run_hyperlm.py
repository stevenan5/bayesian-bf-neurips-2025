...
if __name__ == '__main__':
    ...
    # whether to use merged datasets, i.e. train/valid/test all put together
    use_merged = True
    ...
    for dataset in datasets:
        ...
        # make folder for hyperLM specifically
        method_result_path = os.path.join(dataset_result_path, 'HyperLM')
